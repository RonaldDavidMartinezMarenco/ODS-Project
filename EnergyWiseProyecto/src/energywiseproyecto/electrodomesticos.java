...
public class electrodomesticos {
    ...
    public void mostrarTodosLosElectrodomesticos() {
        ...
        String mensaje1=("Electrodomésticos y sus consumos:\n");
        for (int i = 0; i < n; i++) {
           mensaje1+=(i + 1) + ". " + nombresElectrodomesticos[i] + " - " + consumos[i] + " kWh"+"\n";
        }
    ...
    //CRUD -INSERTAR
     ...
     public void insertarElectrodomestico(int indice, String nombre,double consumo) {
            // Validación de índice
       if (indice < 0 || indice > nombresElectrodomesticos.length) {
           throw new IndexOutOfBoundsException("Índice fuera de rango: " + indice);
       }
