...
public class EnergyProject2 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                mes = scanner.nextInt();
                if (mes == 0) {
                    System.out.print("¿Desea volver al menú anterior (año) o salir del programa? (1-Volver, 2-Salir): ");
            ...
            while (true) {
                System.out.println("Seleccione de qué manera calcular su consumo: ");
                ...
                if (opcionConsumo == 0) {
                    System.out.print("¿Desea volver al menú anterior (mes) o salir del programa? (1-Volver, 2-Salir): ");
                    int volver = scanner.nextInt();
                    if (volver == 1) {
                        mes = -1;
                        break;
            ...
            if (opcionConsumo == 1) {
                while (true) {
                    ...
                    if (consumo == 0) {
                        System.out.print("¿Desea volver al menú anterior (opción de consumo) o salir del programa? (1-Volver, 2-Salir): ");
                        int volver = scanner.nextInt();
                        if (volver == 1) {
                            opcionConsumo = -1;
                            break;
                    ...
                    if (consumo > 0) break;
                    System.out.println("Consumo no válido. Intente de nuevo.");
                }
                ...
                while (true) {
                    ...
                    if (consumo > 0) break;
                    System.out.println("Lectura no válida. Intente de nuevo.");
                }
            }
            ...
            while (true) {
                ...
                if (estrato == 0) {
                    System.out.print("¿Desea volver al menú anterior (consumo) o salir del programa? (1-Volver, 2-Salir): ");
                    int volver = scanner.nextInt();
                    if (volver == 1) {
                        opcionConsumo = -1;
                        break;
                ...
                System.out.println("Estrato no válido. Intente de nuevo.");
            }
            ...
            System.out.printf("El total a pagar por el consumo de energía en %d/%d es: $%.2f%n", mes, año, totalapagar);
            ...
            do{
                ...
                if (consultaElectrodomesticos == 1){
                    ...
                    String nombresElectrodomesticos[] = {"Bombillo","Nevera","Computador","Televisor","Lavadora","Plancha","Secador de pelo","Secadora","Licuadora","Microondas","Aire acondicionado","Ventilador"};
                        while(true){
                             System.out.println("MENU ELECTRODOMÉSTICOS:\n[1] Bombillo\n[2] Nevera\n[3] Computador\n[4] Televisor\n[5] Lavadora\n[6] Plancha\n[7] Secador de pelo\n[8] Secadora\n[9] Licuadora\n[10] Microondas[11]Aire acondicionado[12]Ventilador\n[0] Finalizar selección");
                                ...
                                if (opcionElectrodomesticos == 0) {
                                    ...
                                    System.out.print("Horas de uso del electrodoméstico (" + nombresElectrodomesticos[opcionElectrodomesticos - 1] + "): ");
                            ...
                            for (int i = 0; i < electrodomesticosUser.size(); i++) {
                                ...
                                if (index != -1) {
                                    ...
                                    System.out.printf("El consumo del electrodoméstico %s por las horas ingresadas es: %.2f kWh diarios y el consumo mensual por el momento(%.2f kWh mensuales)%n", electrodomesticosUser.get(i), consumoDiario, totalConsumoElectrodomesticos);
                               }
                            }
                             costoTotalElectrodomesticos = totalConsumoElectrodomesticos * costokwh;
                            System.out.printf("El costo total por el uso de sus electrodomésticos es: $%.2f%n", costoTotalElectrodomesticos);

                        }else if(opcionElectrodomesticosModo== 2){
                            while(true){    
                               System.out.println("Ingrese el nombre del electrodoméstico: o '0' para salir ");
                               scanner.nextLine();
                               ...
                               if(nombreElectrodomestico.equalsIgnoreCase("0")){
                                ...
                                System.out.println("Ingrese el consumo por hora del" + nombreElectrodomestico + "(en kWh)");
                            ...
                            for(int i=0;i<electrodomesticosUser.size();i++){
                            System.out.printf("¿Cuántas horas al día usa el %s?: ", electrodomesticosUser.get(i));
                            horasUso = scanner.nextDouble();
            ...
            System.out.print("¿Desea realizar otra consulta de consumo general? (1-Sí, 2-No): ");
    ...
    public static void sugerenciasElectrodomesticos(Scanner scanner){
        ...
        System.out.println("Sigue estos consejos para lograr un mejor ahorro de energia: ");
        System.out.println("1.Nevera: Evita dejar la puerta de la nevera abierta por tiempo prolongado. Asegúrate de que selle bien y no introduzcas alimentos calientes\n2.Aire Acondicionado: Mantén limpios los filtros y usa el aire acondicionado a temperaturas moderadas, preferiblemente alrededor de 24°C.\n3.Lavadora: Utiliza la lavadora con carga completa y selecciona ciclos de lavado con agua fría para ahorrar energía.4.Secadora: Evita el uso de la secadora eléctrica colgando la ropa al aire libre para que se seque naturalmente.\n5.Cocina: Cocina con ollas a presión y tapas para reducir el tiempo y la energía necesarios para cocinar.\n6.Electrodomésticos en Stand-by: Desconecta los electrodomésticos que no estés utilizando para evitar el consumo fantasma.\n7.Iluminación: Reemplaza las bombillas incandescentes por LED, que ahorran hasta un 80% de energía y duran 25 veces más.\n8.Televisores y Monitores: Apaga los dispositivos cuando no los estés usando y considera ajustar el brillo a un nivel cómodo que no sea excesivamente alto.\n9.Computadoras y Cargadores: Desconecta los cargadores de tus dispositivos electrónicos cuando no estén en uso.\n10.Plancha: Acumula ropa para planchar en una sola sesión y utiliza la plancha con la temperatura adecuada para cada tipo de tela.");
